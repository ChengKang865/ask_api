...
import com.autoask.entity.common.weiixn.Token;
import com.autoask.entity.common.weiixn.WeixinUserInfo;
...
public class CommonUtil {
	...
	public final static String token_url = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&"
			+ "appid=wx27c506e1b032dfcd&secret=d774b0db73b4d03f815cb750cdd4d8b7";
	...
	public static void main(String args[]) {
		String accessToken = CommonUtil.getToken("wx0a0703a588c2d202", "0c0635b36bf3d103406d566eb5bef9d1")
				.getAccessToken();
		/**
		 * 获取用户信息
		 */
	 ...
	 * @return
	 */
	public static String imageAndText(String fromUserName, String toUserName, String description, String picUrl,
