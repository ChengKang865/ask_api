...
import com.autoask.pay.ali.sign.MD5;
import com.autoask.pay.ali.util.httpClient.HttpProtocolHandler;
import com.autoask.pay.ali.util.httpClient.HttpRequest;
import com.autoask.pay.ali.util.httpClient.HttpResponse;
import com.autoask.pay.ali.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        ...
        sbHtml.append("<button type=\"submit\">" + strButtonName + "</button></form>");
//        sbHtml.append("<script>document.forms['alipaysubmit'].submit();</script>");
     ...
     */
    private static NameValuePair[] generateNameValuePair(Map<String, String> properties) {
