...
DROP TABLE IF EXISTS order_goods_share;
CREATE TABLE order_goods_share (
  ...
  COMMENT '创建时间',
  PRIMARY KEY (id),
  UNIQUE KEY u_idx_0 (order_goods_id),
  INDEX idx_0 (order_id),
  INDEX idx_1 (ad_id, ad_type),
  INDEX idx_2 (service_id, service_type),
  INDEX idx_3  (handle_id),
  INDEX idx_4 (promote_id, promote_type),
  INDEX idx_5 (factory_id),
  INDEX idx_6 (partner_id),
  INDEX idx_7 (create_time DESC)
)
  ENGINE = InnoDB
  DEFAULT CHARSET = utf8
  COMMENT = 'order_goods对应的分成';